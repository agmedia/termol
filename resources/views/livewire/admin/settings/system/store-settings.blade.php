<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <h1 class="text-xl font-semibold tracking-tight">Store Settings</h1>
        <p class="mt-2 text-sm text-slate-600">Central place for storefront email, branding, newsletter, and announcement bar settings.</p>
    </div>
    ...
    <div class="admin-panel admin-form-panel p-6">
        ...
        <form wire:submit="save" class="space-y-4">
            @if ($tab === 'email')
                <div class="grid gap-4 md:grid-cols-2">
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 md:col-span-2">
                        ...
                        Enable store email notifications
                    </label>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Mailer</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">From Address</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">From Name</label>
                        <input type="text" wire:model="form.store_email_from_name" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Reply-To</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Orders To</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Contact Forms To</label>
                    ...
                    <div class="md:col-span-2 grid gap-3 md:grid-cols-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">SMTP Host</label>
                            <input type="text" wire:model="form.store_email_smtp_host" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                        </div>
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">SMTP Port</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Encryption</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">SMTP Username</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">SMTP Password</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Sendmail Path</label>
            ...
            @if ($tab === 'branding')
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Store Name</label>
                        <input type="text" wire:model="form.store_brand_name" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Footer Phone</label>
                        <input type="text" wire:model="form.store_footer_phone" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Footer Sales Email</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Footer Support Email</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Footer Working Hours</label>
                    ...
                    <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-4">
                        <h3 class="text-sm font-bold text-slate-800">Footer Link Columns</h3>
                        <p class="mt-1 text-xs text-slate-600">Configure 3 footer columns: title + product categories + pages + custom links.</p>
                    </div>
                    @foreach ([1, 2, 3] as $col)
                        <div class="md:col-span-2 rounded-xl border border-slate-200 p-4">
                            <p class="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Column {{ $col }}</p>
                            <div class="grid gap-3 md:grid-cols-4">
                                ...
                                <div>
                                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Product Categories</label>
                                ...
                                <div>
                                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Pages</label>
                                    <div class="max-h-40 space-y-1 overflow-auto rounded-xl border border-slate-300 p-2 text-sm">
                                ...
                                <div>
                                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Custom Links</label>
                                    <textarea wire:model="form.store_footer_col_{{ $col }}_custom_links" rows="6" class="w-full rounded-xl border border-slate-300 px-3 py-2 font-mono text-xs" placeholder="Blog|/blog&#10;FAQ|/page/faq&#10;Kontakt|/contact"></textarea>
                                    <p class="mt-1 text-xs text-slate-500">One per line: <code>Label|URL</code></p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    <div class="md:col-span-2 rounded-xl border border-slate-200 p-4">
                        <p class="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Bottom Footer Bar</p>
                        <div class="grid gap-3 md:grid-cols-2">
                            <div>
                                <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Copyright text</label>
                                <input type="text" wire:model="form.store_footer_bottom_copyright_text" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" placeholder="Sva prava pridržana." />
                            </div>
                            <div>
                                <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Bottom links (pages)</label>
                                <div class="max-h-40 space-y-1 overflow-auto rounded-xl border border-slate-300 p-2 text-sm">
                                    @foreach (($pageOptions ?? []) as $option)
                                        <label class="flex items-center gap-2">
                                ...
                                <p class="mt-1 text-xs text-slate-500">Order in this list = display order in footer.</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Logo</label>
                        <input type="file" wire:model="logoUpload" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                        <p class="mt-1 text-xs text-slate-500">Allowed: JPG, PNG, WEBP, AVIF, SVG</p>
                        @if ($form['store_brand_logo_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_brand_logo_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Favicon</label>
                        <input type="file" wire:model="faviconUpload" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                        <p class="mt-1 text-xs text-slate-500">Auto-generate: 16, 32, 180, 192, 512 and ICO.</p>
                        @if ($form['store_brand_favicon_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_brand_favicon_path'] }}</p>
                        @endif
                    </div>
                    <div class="md:col-span-2 grid gap-3 md:grid-cols-2">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Facebook URL</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Instagram URL</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">TikTok URL</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">YouTube URL</label>
            ...
            @if ($tab === 'newsletter')
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Provider</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Mailchimp API Key</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Mailchimp List ID</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Klaviyo API Key</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Klaviyo List ID</label>
            ...
            @if ($tab === 'integrations')
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-4">
                        <h3 class="text-sm font-bold text-slate-800">reCAPTCHA v3</h3>
                        <p class="mt-1 text-xs text-slate-600">Protect forms (contact, checkout later) from spam bots.</p>
                    </div>
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 md:col-span-2">
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Site key</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Secret key</label>
                    ...
                    <div class="md:col-span-2 md:w-56">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Min score</label>
                    ...
                    <div class="md:col-span-2 rounded-xl border border-slate-200 bg-slate-50 p-4 mt-2">
                        <h3 class="text-sm font-bold text-slate-800">Google Analytics (GA4)</h3>
                        <p class="mt-1 text-xs text-slate-600">Inject global gtag script and push purchase event on checkout success.</p>
                    </div>
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 md:col-span-2">
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">GA4 Measurement ID</label>
                    ...
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 md:col-span-2">
                        ...
                        Enable purchase event on successful checkout
                    </label>
                    <div class="md:w-72">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Purchase event name</label>
            ...
            @if ($tab === 'seo')
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Default Title</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Default Meta Description</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Robots</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Canonical policy</label>
                        <select wire:model="form.store_seo_canonical_policy" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm">
                            <option value="self">Self URL</option>
            ...
            @if ($tab === 'og')
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Default OG image</label>
                        ...
                        @if ($form['store_og_default_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_default_image_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Home OG override</label>
                        ...
                        @if ($form['store_og_home_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_home_image_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Category OG override</label>
                        ...
                        @if ($form['store_og_category_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_category_image_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Product OG override</label>
                        ...
                        @if ($form['store_og_product_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_product_image_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Page OG override</label>
                        ...
                        @if ($form['store_og_page_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_page_image_path'] }}</p>
                        @endif
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Blog OG override</label>
                        ...
                        @if ($form['store_og_blog_image_path'])
                            <p class="mt-1 text-xs text-slate-500">Current: {{ $form['store_og_blog_image_path'] }}</p>
                        @endif
                    </div>
                </div>
            @endif
            ...
            @if ($tab === 'schema')
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700">
                        ...
                        ItemList (shop/category/blog list)
                    </label>
                    <label class="inline-flex items-center gap-2 text-sm font-semibold text-slate-700">
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Organization type</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Business Name</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Business Phone</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Business Email</label>
                    ...
                    <div class="md:col-span-2 grid gap-3 md:grid-cols-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Street</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">City</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Region</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Postal code</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Country code</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Product currency</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">SameAs URLs (one per line)</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Blog author name (default)</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Blog author profile URL</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">FAQ group code (optional)</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">FAQ max items</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">ItemList max products/posts</label>
            ...
            @if ($tab === 'announcement')
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Text</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Link URL (optional)</label>
            ...
            <div class="pt-2">
                <button type="submit" class="rounded-xl bg-cyan-700 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-800">Save Store Settings</button>
            </div>
        </form>
    </div>
</div>
