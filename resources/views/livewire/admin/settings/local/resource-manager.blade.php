        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">
                    Settings namespace: <code>Settings/Local/{{ str_replace('-', '', ucwords($resource, '-')) }}</code>
                </p>
                <p class="mt-2 text-xs text-slate-500">Items per page: <span class="admin-chip">{{ $perPage }}</span></p>
            </div>
            <div class="w-full sm:w-72">
                <label for="settings-search" class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Search</label>
                <input
                    id="settings-search"
                    type="text"
        ...
        <div class="admin-panel admin-form-panel p-6" style="order:2;">
            ...
            <form wire:submit="save" class="admin-form mt-4 space-y-4">
                ...
                @if (in_array('geo_zone_id', $resources[$resource]['fields'], true))
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Geo zone</label>
                ...
                @if (in_array('country_code', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Country</label>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Postal from</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Postal to</label>
                ...
                @if (in_array('fee_type', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Fee type</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Fee value</label>
                ...
                @if (in_array('price', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Price</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Free over</label>
                ...
                @if (in_array('min_subtotal', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Max subtotal</label>
                ...
                @if (in_array('rate_type', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Rate type</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Rate</label>
                ...
                @if (in_array('symbol', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Symbol</label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Position</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Exchange rate</label>
                ...
                @if (in_array('locale', $resources[$resource]['fields'], true))
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Direction</label>
                    ...
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Native name</label>
                ...
                @if (in_array('color', $resources[$resource]['fields'], true))
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Color token</label>
                ...
                @if (in_array('settings_text', $resources[$resource]['fields'], true))
                    <div>
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Settings JSON</label>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    @if (in_array('decimal_places', $resources[$resource]['fields'], true))
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Decimals</label>
            ...
            <div class="mt-4 overflow-x-auto">
                <table class="admin-items-table min-w-full text-sm">
                    <thead class="text-slate-600">
                        <tr>
                            <th class="px-3 py-2 text-center font-semibold">Code</th>
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2 text-right">
                                    <div class="inline-flex items-center gap-1">
                                        ...
                                        <button type="button" wire:click="delete({{ $row->id }})" wire:confirm="Delete this item?" class="rounded-lg border border-rose-200 px-2 py-1 text-xs font-semibold text-rose-700 hover:bg-rose-50">Delete</button>
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-3 py-8 text-center text-sm text-slate-500">No records yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
