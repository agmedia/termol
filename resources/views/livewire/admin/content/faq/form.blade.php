<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Content / FAQs</p>
                <h1 class="mt-2 text-2xl font-semibold tracking-tight text-slate-900">{{ $isEdit ? 'Edit FAQ' : 'Create FAQ' }}</h1>
                <p class="mt-2 text-sm text-slate-600">Structured FAQ entry with locale-specific question and answer.</p>
            </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="admin-panel admin-form-panel p-6">
            ...
            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                ...
                <div style="grid-column: span 3;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Group Code</label>
            ...
            <div class="mt-4 flex flex-wrap items-center gap-3">
                <button
                    ...
                    aria-label="Toggle faq active state"
                >
                ...
                <button
                    ...
                    aria-label="Toggle faq featured state"
                >
                    <span class="admin-switch-track"><span class="admin-switch-thumb"></span></span>
        ...
        <div class="grid gap-6 xl:grid-cols-2">
            <div class="admin-panel admin-form-panel p-6">
                ...
                <div class="mt-4">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Question</label>
                ...
                <div class="mt-3">
                    <label for="faq-answer-html" class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Answer</label>
                    <textarea id="faq-answer-html" rows="10" wire:model="form.answer_html" data-quill-editor class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
            ...
            <div class="admin-panel admin-form-panel p-6">
                ...
                <div class="mt-3">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">FAQ Payload JSON</label>
