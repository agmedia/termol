<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex items-end justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight">Blog Posts</h1>
                <p class="mt-1 text-sm text-slate-600">Manage blog content with locale-specific slugs and SEO fields.</p>
        ...
        <div class="mt-4 overflow-x-auto">
            <table class="admin-items-table min-w-full text-sm">
                <thead class="text-slate-600">
                    <tr>
                        <th class="px-3 py-2 text-left font-semibold">Post</th>
                        <th class="px-3 py-2 text-left font-semibold">Slug</th>
                        <th class="px-3 py-2 text-center font-semibold">Published</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-3 py-8 text-center text-sm text-slate-500">No blog posts yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
