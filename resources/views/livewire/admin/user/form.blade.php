<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-semibold tracking-tight text-slate-900">Edit User</h1>
                <p class="mt-2 text-sm text-slate-600">Update identity, segmentation, profile and addresses in one place.</p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                <span class="admin-chip">User ID: {{ $userId }}</span>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="admin-panel admin-form-panel p-6">
            ...
            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                ...
                <div style="grid-column: span 2;">
                    ...
                    <select wire:model="form.customer_groups" multiple data-tom-select data-tom-placeholder="Select groups..." class="admin-select w-full rounded-xl border border-slate-300 px-3 py-2 text-sm">
            ...
            <div class="mt-4 flex flex-wrap items-center gap-3">
                <button
                    ...
                    aria-label="Toggle email verified state"
                >
                    <span class="admin-switch-track"><span class="admin-switch-thumb"></span></span>
                    <span class="admin-switch-label">{{ $form['email_verified'] ? 'Email Verified' : 'Email Unverified' }}</span>
                </button>
            </div>
        </div>
        ...
        <div class="admin-panel admin-form-panel p-6">
            ...
            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">First Name</label>
                    <input type="text" wire:model="form.profile.first_name" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                </div>
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Last Name</label>
                    <input type="text" wire:model="form.profile.last_name" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                </div>
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Phone</label>
                    <input type="text" wire:model="form.profile.phone" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                </div>
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Birthday</label>
                    <input type="date" wire:model="form.profile.birthday" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                </div>
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Gender</label>
                ...
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Affiliate Name</label>
                ...
                <div style="grid-column: span 3;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Company</label>
                    <input type="text" wire:model="form.profile.company" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                </div>
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">OIB</label>
                ...
                <div style="grid-column: span 2;">
                    <div class="mt-6 flex items-center">
                        <button
                            ...
                            aria-label="Toggle newsletter opt in"
                        >
                            <span class="admin-switch-track"><span class="admin-switch-thumb"></span></span>
                            <span class="admin-switch-label">{{ $form['profile']['newsletter_opt_in'] ? 'Newsletter On' : 'Newsletter Off' }}</span>
                        </button>
                    </div>
                </div>
                <div style="grid-column: span 5;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Bio</label>
        ...
        <div class="admin-panel admin-form-panel p-6">
            <p class="admin-section-title">Billing Address</p>
            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">First Name</label>
                ...
                <div style="grid-column: span 3;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">VAT ID</label>
                ...
                <div style="grid-column: span 6;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Address Line 1</label>
                ...
                <div style="grid-column: span 6;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Address Line 2</label>
                ...
                <div style="grid-column: span 1;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">CC</label>
        ...
        <div class="admin-panel admin-form-panel p-6">
            <p class="admin-section-title">Shipping Address</p>
            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                <div style="grid-column: span 2;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">First Name</label>
        ...
        <div class="admin-panel admin-form-panel p-6">
            <p class="admin-section-title">Password Reset (Optional)</p>
            <p class="mt-1 text-sm text-slate-600">Leave blank to keep current password.</p>

            <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(12, minmax(0, 1fr));">
                <div style="grid-column: span 3;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">New Password</label>
                ...
                <div style="grid-column: span 3;">
                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Confirm Password</label>
