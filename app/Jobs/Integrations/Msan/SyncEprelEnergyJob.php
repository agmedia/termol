...
class SyncEprelEnergyJob implements ShouldBeUnique, ShouldQueue
{
    use Queueable;
    ...
    public function failed(?Throwable $exception): void
    {
        $message = preg_replace(
            ...
            '$1=[skriveno]',
            $exception?->getMessage() ?: 'EPREL sinkronizacija energetskih podataka nije dovršena.',
        );
