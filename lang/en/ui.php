...
return [
    ...
    'shop' => [
        ...
        'filters' => [
            'search' => 'Search',
            'header_search_placeholder' => 'Search the online store...',
            ...
            'price_from' => 'From',
            'price_to' => 'To',
            'available_only' => 'Show only immediately available',
    ...
    'featured_categories' => [
        ...
        'product_count' => '{0} 0 products|{1} 1 product|[2,*] :count products',
        'subcategory_count' => '{0} 0 subcategories|{1} 1 subcategory|[2,*] :count subcategories',
        'empty' => 'No featured categories have been selected.',
        'image_alt' => ':name – featured category',
    ],
    'popular_brands' => [
        'title' => 'Popular brands',
        'view_all' => 'All brands',
        'empty' => 'No popular brands have been selected.',
        'image_alt' => ':name brand logo',
    ...
    'product' => [
        ...
        'no_payment_methods' => 'There are currently no active payment methods.',
        ...
        'specifications_general' => 'General specifications',
        'energy_label' => 'Energy label',
        'energy_class_and_range' => 'Energy class :class, range :range',
        'open_energy_label' => 'Open energy label, class :class, range :range',
        'product_information_sheet' => 'Product information sheet',
        'information_sheet_short' => 'Information sheet',
        'open_product_information_sheet' => 'Open product information sheet',
        'energy_documents' => 'Energy labels and product information sheets',
        'eprel_registration_number' => 'EPREL registration number',
        ...
        'b2b_contract_price' => 'Your contracted B2B price',
    ...
    'auth' => [
        ...
        'register' => [
            ...
            'go_to_login' => 'Sign in',
            'terms_prefix' => 'By registering, I accept the',
            'terms_link' => 'Terms of use',
            'b2b_accuracy' => 'I confirm that the business information is correct and accept verification of the B2B request.',
        ],
        'forgot' => [
            'page_title' => 'Forgot password',
            'heading' => 'Forgot your password?',
            'subheading' => 'Request a link to set a new password.',
            'form_eyebrow' => 'Account recovery',
            'form_title' => 'Request a new password',
            'intro' => 'Enter the email address for your customer account. If the account exists, we will send you a password reset link.',
            'submit' => 'Send reset link',
            'submitting' => 'Sending...',
            'status' => 'If an account exists for that email address, we have sent a link to set a new password.',
            'throttled' => 'Too many requests were sent. Wait a minute and try again.',
            'back_eyebrow' => 'Remembered your password?',
            'back_title' => 'Back to login',
            'back_text' => 'Sign in with your email address and current password.',
            'back_action' => 'Back to login',
        ],
        'reset' => [
            'page_title' => 'New password',
            'heading' => 'Set a new password',
            'subheading' => 'Choose a new secure password for your customer account.',
            'form_title' => 'New password',
            'intro' => 'Confirm your email address and enter the new password twice.',
            'submit' => 'Save new password',
            'status' => 'Your password has been changed. You can now sign in.',
            'invalid' => 'This password reset link is invalid or has expired. Request a new link.',
            'side_eyebrow' => 'Secure change',
            'side_title' => 'Protect your account',
            'side_text' => 'Choose a unique password that you do not use on other websites.',
        ],
        'validation' => [
            ...
            'terms_accepted' => 'You must accept the Terms of use to register.',
            'security_check' => 'security check',
        ],
    ],
    'account' => [
