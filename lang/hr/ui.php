...
return [
    ...
    'product' => [
        ...
        'specifications_general' => 'Opće specifikacije',
        'energy_label' => 'Energetska oznaka',
        'energy_class_and_range' => 'Energetska klasa :class, raspon :range',
        'open_energy_label' => 'Otvori energetsku oznaku, klasa :class, raspon :range',
        'product_information_sheet' => 'Informacijski list proizvoda (PIS)',
        'information_sheet_short' => 'Informacijski list',
        'open_product_information_sheet' => 'Otvori informacijski list proizvoda (PIS)',
        'energy_documents' => 'Energetske oznake i informacijski listovi',
        'eprel_registration_number' => 'EPREL registracijski broj',
    ...
    'auth' => [
        'back_to_store' => 'Natrag u trgovinu',
        ...
        'fields' => [
            ...
            'terms' => 'Opći uvjeti korištenja',
        ],
        'login' => [
            'page_title' => 'Prijava',
            'heading' => 'Prijava',
            'subheading' => 'Prijavite se u svoj korisnički račun.',
            'form_eyebrow' => 'Siguran pristup',
        ...
        'register' => [
            ...
            'go_to_login' => 'Prijava',
            'terms_prefix' => 'Registracijom prihvaćam',
            'terms_link' => 'Opće uvjete korištenja',
            'b2b_accuracy' => 'Potvrđujem da su uneseni poslovni podaci točni i prihvaćam provjeru B2B zahtjeva.',
        ],
        'forgot' => [
            'page_title' => 'Zaboravljena lozinka',
            'heading' => 'Zaboravljena lozinka',
            'subheading' => 'Pošaljite si poveznicu za postavljanje nove lozinke.',
            'form_eyebrow' => 'Oporavak računa',
        ...
        'validation' => [
            ...
            'postal_code_required' => 'Poštanski broj je obavezan.',
            'city_required' => 'Grad je obavezan.',
            'country_required' => 'Država je obavezna.',
            'password_required' => 'Lozinka je obavezna.',
            'password_confirmed' => 'Lozinke se ne podudaraju.',
            'terms_accepted' => 'Za registraciju morate prihvatiti Opće uvjete korištenja.',
            'security_check' => 'sigurnosna provjera',
        ],
    ],
    'account' => [
